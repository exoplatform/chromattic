...
public interface A<X, Y extends Number> {
  ...
  void setWildcard(Collection<?> wildcard);

  Collection<? extends A> getWildcardWithSingleUpperBound();

  void setWildcardWithSingleUpperBound(Collection<? extends A> wildcardWithSingleUpperBound);
  ...
  void setBoundedTypeVariable(Y x);
