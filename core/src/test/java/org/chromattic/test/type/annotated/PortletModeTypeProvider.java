...
public class PortletModeTypeProvider extends SimpleTypeProvider.STRING<PortletMode> {
  ...
  @Override
  public PortletMode getExternal(String s) throws TypeConversionException {
    return new PortletMode(s);
  }

  @Override
  public PortletMode fromString(String s) throws TypeConversionException {
    return new PortletMode(s);
  }
