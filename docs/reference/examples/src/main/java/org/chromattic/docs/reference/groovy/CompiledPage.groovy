...
class CompiledPage implements GroovyInterceptable { // <> Implements GroovyInterceptable
  ...
  private MethodHandler chromatticInvoker; // <> The method handler was created
  ...
  public CompiledPage(MethodHandler chromatticInvoker) { // <> Initializer constructor was created
    this.chromatticInvoker = chromatticInvoker;
  }
  ...
  public Object setProperty(String p, Object v) {
    return ChromatticGroovyInvocation.setProperty(this, p, v, chromatticInvoker)
  }
}
