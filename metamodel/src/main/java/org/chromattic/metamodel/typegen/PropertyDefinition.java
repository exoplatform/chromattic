...
public class PropertyDefinition {
  ...
  <V> PropertyDefinition(JCRPropertyMapping mapping, PropertyQualifier<SimpleValueInfo> propertyInfo) {
    this.multiple = propertyInfo instanceof MultiValuedPropertyQualifier;
