...
package org.chromattic.groovy.core.format.scope;

import org.chromattic.test.format.A;
import org.chromattic.test.format.B;
import org.chromattic.test.format.C;
import org.chromattic.test.format.scope.FormatterScopeTestCase;
 ...
 */
@UniversalTest(
  sourceClass = FormatterScopeTestCase.class,
  baseDir = "core",
  suffix = "CoreTest",
  chromatticClasses = {A.class, B.class, C.class})
public class GroovyFormatterScopeTestCase {
}
